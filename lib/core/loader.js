...
function loadDataFile (filename) {
  ...
  // Convert <br> tags to newlines before cleaning other tags.
  xml = xml.replace(/<br\s*\/?>/gi, '\n')

  // Remove other inline tags.
  const otherTags = tagsToClean.filter(tag => !tag.match(/<br/i))
  xml = cleanTokens(otherTags, xml)
